...
if (vehicle.upper() == "C"):
    if (tot_hours <=2): fee = tot_hours
    else: fee = 2 + (tot_hours-2)*1.75
elif (vehicle.upper() == "B"):
    if (tot_hours <=2): fee = 3*tot_hours
    else: fee = 6 + (tot_hours-2)*3.25
elif (vehicle.upper() == "T"):
    if (tot_hours <=2): fee = 2*tot_hours
    else: fee = 4 + (tot_hours-2)*2.75
